...
if __name__ == "__main__":
    ...
    '''
    init_theta = np.matrix(np.ones((d+1,1)))*2  # note that we really should be initializing this to be near zero, but starting it near [10,10] works better to visualize gradient descent for this particular problem
    """IDEA: stop if start to rise for 4 consequtive steps"""
    n_iter = 200
    alpha = 0.002
    momentum = 0.99
    # Instantiate objects
